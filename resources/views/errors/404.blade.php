...
@section('title', __('404 - Ukurasa Haujapatikana'))
@section('page-title', __('Ukurasa Haujapatikana'))
@section('page-subtitle', __('Ukurasa unaoutafuta haupo'))
    ...
    <div class="max-w-lg w-full text-center">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 md:p-12">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
                {{ __('Ukurasa Haujapatikana') }}
            </h1>
            <p class="text-gray-600 mb-8">
                {{ __('Samahani, ukurasa unaoutafuta haupo au umehamishwa. Tafadhali rudi nyumbani au jaribu kutafuta tena.') }}
            </p>
...
<head>
    ...
    <title>{{ __('404 - Ukurasa Haujapatikana') }}</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-lg w-full text-center">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <p class="text-gray-600 mb-8">
                {{ __('Samahani, ukurasa unaoutafuta haupo au umehamishwa. Tafadhali rudi nyumbani au wasiliana na msimamizi.') }}
            </p>
