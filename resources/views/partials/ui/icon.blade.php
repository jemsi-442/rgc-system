...
<svg viewBox="0 0 24 24" aria-hidden="true" class="{{ $class }}" width="{{ $size }}" height="{{ $size }}" fill="none" stroke="currentColor" stroke-width="{{ $strokeWidth }}" stroke-linecap="round" stroke-linejoin="round">
    @switch($name)
        ...
        @case('youtube')
            <path d="M21 12s0-3.3-.42-4.7a2.5 2.5 0 0 0-1.76-1.76C17.42 5.12 12 5.12 12 5.12s-5.42 0-6.82.42A2.5 2.5 0 0 0 3.42 7.3C3 8.7 3 12 3 12s0 3.3.42 4.7a2.5 2.5 0 0 0 1.76 1.76c1.4.42 6.82.42 6.82.42s5.42 0 6.82-.42a2.5 2.5 0 0 0 1.76-1.76C21 15.3 21 12 21 12Z" />
            <path d="m10.2 9.1 4.7 2.9-4.7 2.9V9.1Z" />
            @break

        @case('tiktok')
            <path d="M14.5 4v9.2a4.8 4.8 0 1 1-4.8-4.8" />
            <path d="M14.5 4c.5 3.1 2.2 4.9 5 5.2" />
            <path d="M9.7 12.2a2.1 2.1 0 1 0 2.1 2.1V4" />
            @break
