                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4 mt-2 flex-wrap">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-lg opacity-90">Namba: {{ $member->member_number }}</span>
                                </div>
                                @if($member->is_active)
                                ...
                                @else
                                    <span class="inline-flex items-center px-3 py-1 bg-red-500 text-white rounded-full text-sm font-semibold">
                                        <i class="fas fa-times-circle mr-1.5"></i>Asiyetumika
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-white opacity-80">Tarehe ya Uanachama</p>
                            <p class="text-xl font-bold">{{ \Carbon\Carbon::parse($member->membership_date)->format('d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
