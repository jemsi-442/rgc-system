...
@section('title', 'Ongeza Mapato - Mfumo wa Kanisa')
@section('page-title', 'Ongeza Mapato')
@section('page-subtitle', 'Jaza fomu hapa chini kuongeza mapato mapya')
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Ongeza Mapato Mapya</h1>
            </div>
            <p class="text-gray-600">Jaza taarifa za mapato yanayokusanywa</p>
        </div>
    </div>

    <!-- Form Container -->
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <form method="POST" action="{{ route('income.store') }}" class="divide-y divide-gray-200">
            @csrf
            ...
            <div class="p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Jaza taarifa za kimsingi za mapato</p>
                    </div>
                </div>
