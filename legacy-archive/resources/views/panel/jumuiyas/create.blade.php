...
@section('title', 'Ongeza Jumuiya - Mfumo wa Kanisa')
@section('page-title', 'Ongeza Jumuiya')
@section('page-subtitle', 'Sajili jumuiya mpya')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Ongeza Jumuiya Mpya</h1>
            <p class="text-gray-600 mt-2">Jaza fomu hii kusajili jumuiya mpya</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-primary-50 to-white">
            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                <i class="fas fa-users text-primary-500 mr-2"></i> Taarifa za Jumuiya
            </h3>
        </div>

        <form action="{{ route('jumuiyas.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              placeholder="Maelezo mafupi kuhusu jumuiya hii...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
