...
@section('title', 'Omba Fedha - Mfumo wa Kanisa')
@section('page-title', 'Omba Fedha')
@section('page-subtitle', 'Jaza fomu hapa chini kuwasilisha ombi la fedha')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Omba Fedha</h1>
            </div>
            <p class="text-gray-600">Jaza taarifa za ombi la fedha</p>
        </div>
    </div>
    ...
    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg">
        <div class="flex items-start">
            <i class="fas fa-hashtag text-blue-400 mt-1 mr-3"></i>
            <div>
                <p class="text-sm text-blue-700">
                    <strong>Namba ya Ombi:</strong> {{ $nextRequestNumber }}
                    <span class="ml-2 text-xs">(Itazalishwa moja kwa moja)</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <form method="POST" action="{{ route('requests.store') }}" class="divide-y divide-gray-200">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="department" name="department" value="{{ old('department') }}" required
                                   class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-gray-900 @error('department') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="amount_requested" name="amount_requested" value="{{ old('amount_requested') }}" step="0.01" min="0" required
                                   class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-gray-900 @error('amount_requested') border-red-500 @enderror"
                                   placeholder="0.00">
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" id="requested_date" name="requested_date" value="{{ old('requested_date', date('Y-m-d')) }}" required
                                   class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-gray-900 @error('requested_date') border-red-500 @enderror">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="description" name="description" rows="6" required
                                      ...
                                      placeholder="Eleza kwa undani kuhusu ombi lako, sababu za kuhitaji fedha hizi, na jinsi fedha zitatumika...">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                        @enderror
    ...
    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg">
        <div class="flex items-start">
            ...
            <div>
                <p class="text-sm text-blue-700">
                    <strong>Maelekezo:</strong> Baada ya kuwasilisha ombi, litasubiri idhini kutoka kwa Mchungaji au Mhasibu. Utapokea taarifa baada ya ombi kuangaliwa.
                </p>
            </div>
        </div>
    </div>
