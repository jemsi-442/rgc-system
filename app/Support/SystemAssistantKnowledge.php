    ...
    protected static function englishTopics(): array
    {
        return [
            ...
            [
                ...
                'answer' => 'You can use the Giving flow to choose the giving type, enter an amount, and open a secure Snippe checkout link. After payment confirmation, the system records the final offering in the correct branch ledger and makes a receipt available on the status page.',
            ...
            [
                ...
                'title' => 'Member giving',
                'keywords' => ['offering', 'giving', 'payment', 'sadaka', 'contribution', 'snippe'],
                'answer' => 'As a member, you can use the Giving page to choose the giving type, enter an amount, and open a Snippe checkout link. After payment confirmation, the system posts the final offering to the branch ledger and makes a receipt available for download.',
                'suggestions' => ['Where is the Giving page?', 'How do I get a receipt?', 'What giving types can I use?'],
                'roles' => ['member'],
                'sort_order' => 121,
            ],
            [
                ...
                'keywords' => ['payment request', 'snippe', 'checkout link', 'offering payment', 'sync payment'],
                'answer' => 'For admins, the Offering payment tools can create Snippe hosted checkout links, track pending requests, sync status, review alerts, and confirm that successful payments have already posted into the branch ledger.',
    ...
    protected static function swahiliTopics(): array
    {
        return [
            ...
            [
                ...
                'answer' => 'Unaweza kutumia mtiririko wa Giving kuchagua aina ya utoaji, kuingiza kiasi, na kufungua Snippe checkout link iliyo salama. Malipo yakithibitishwa, mfumo unaandika offering ya mwisho kwenye ledger sahihi ya tawi na kufanya receipt ipatikane kwenye status page.',
            ...
            [
                ...
                'keywords' => ['offering', 'sadaka', 'giving', 'mchango', 'payment', 'snippe', 'toa sadaka', 'toa offering'],
                'answer' => 'Kama member, unaweza kutumia Giving page kuchagua aina ya utoaji, kuingiza kiasi, na kufungua Snippe checkout link. Malipo yakithibitishwa, mfumo unaandika offering ya mwisho kwenye ledger ya tawi na kufanya receipt ipatikane kwa kupakua.',
                'suggestions' => ['Giving page iko wapi?', 'Receipt inapatikana wapi?', 'Ni aina gani za utoaji zinaruhusiwa?'],
                'roles' => ['member'],
                'sort_order' => 121,
            ],
            [
                ...
                'keywords' => ['payment request', 'snippe', 'checkout link', 'offering payment', 'sync payment'],
                'answer' => 'Kwa admins, zana za Offering payments zinaweza kutengeneza Snippe hosted checkout links, kufuatilia requests zinazosubiri, kusync status, ku-review alerts, na kuthibitisha kuwa malipo yaliyofanikiwa tayari yameingia kwenye branch ledger.',
